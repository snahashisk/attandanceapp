...
function App() {
  const students = [
    ...
    { rollno: "CS/20/04", name: "Arindam Ojha" },
    { rollno: "CS/20/05", name: "Atiqur Rahman" },
    { rollno: "CS/20/06", name: "Bandana Nanda" },
    { rollno: "CS/20/07", name: "Debayan Ghosh" },
    { rollno: "CS/20/08", name: "Debjyoti Adak" },
    { rollno: "CS/20/09", name: "Hrithik Das" },
    { rollno: "CS/20/10", name: "Mubassir Ali" },
